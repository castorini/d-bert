...
from dbert.distill.data import find_dataset, set_seed, list_field_mappings, replace_embs
...
def main():
    ...
    for epoch_idx in tqdm(range(args.epochs), position=0):
        ...
        for batch in training_iter:
            ...
            loss = args.ce_lambda * criterion(logits, batch.label) + kd
            loss.backward()
